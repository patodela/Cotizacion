                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="TablaPersonalInterno" >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="active text-center" colspan="6"><strong>Información de el Punto</strong></td>
                            </tr>
                           
                            <tr>
                                <td class="active" colspan="2"> <strong>Funcion</strong></td>
                                <td colspan="2">
                    ...
                    <div class="form-group has-feedback">
                        <label class="input-group">
                            <span class="input-group-addon">
                                <input id="Pnatural" type="radio" name="Activo" value="0" />
                            </span>
                    ...
                    <div class="form-group has-feedback ">
                        <label class="input-group">
                            ...
                            <tr>
                                <td class="input-group-addon danger">1</td>
                                <td class="active text-center" colspan="6"><strong>Identificación del Punto</strong></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                  <asp:DropDownList ID="DropDownList3" CssClass="form-control dropdown" runat="server"></asp:DropDownList>

                                </td>
                            </tr>
                             <tr>
                                <td class="active" colspan="2"><strong>Estado</strong></td>
                                <td colspan="2">
                                   <asp:DropDownList ID="DropDownList4" CssClass="form-control dropdown" runat="server"></asp:DropDownList>
                                ...
                                <td><asp:TextBox class="form-control" ID="TextBox20" TextMode="Phone" runat="server"></asp:TextBox></td>
                                 ...
                                 <tr>
                                <td class="active" colspan="2"><strong>Direccion Laboral</strong></td>
                                 <td colspan="5">
                                    <div class="form-inline">
                                        <div class="form-group">
                                           <div class="input-group">
                             ...
                             <tr>
                                ...
                                <td class="active text-center" colspan="6"><strong>Administrador</strong></td>
                            </tr>
                            <tr>
                                ...
                                <td class="active"><strong>Codigo Fecha</strong></td>
                                 <td colspan="2">
